...
jogging = Workout.create(name: "jogging", description: "jogging is a form of cardio exercise that's easily accessible. It is one of the most straightforward ways to get the important benefits of exercise. Since it improves aerobic fitness, jogging is a great way to help improve cardiovascular health.", detail: "45 - 60 minutes/workout", video: " ", image: " ")
